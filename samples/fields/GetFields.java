			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (Fields field : fields)
					{
						...
						System.out.println("Field HistoryTrackingEnabled: " + field.getHistoryTrackingEnabled());
						...
						if (field.getHistoryTracking() != null)
						{
							...
							System.out.println("Field HistoryTracking RelatedListName: " + historytracking.getRelatedListName());
							System.out.println("Field HistoryTracking DurationConfiguration: " + (historytracking.getDurationConfiguration() != null ? historytracking.getDurationConfiguration().getValue() : ""));
							
							if(historytracking.getFollowedFields() != null)
							{
								List<MinifiedField> followedFields = historytracking.getFollowedFields();
								for(MinifiedField followedField : followedFields)
								{
									System.out.println("Field HistoryTracking FollowedFields APIName: " + followedField.getAPIName());
									System.out.println("Field HistoryTracking FollowedFields Id: " + followedField.getId());
								}
							}
							...
							if (module != null)
							{
								...
								System.out.println("Field HistoryTracking Module  display label" + module.getDisplayLabel());
								System.out.println("Field HistoryTracking Module  api name" + module.getAPIName());
								System.out.println("Field HistoryTracking Module  id" + module.getId());
								System.out.println("Field HistoryTracking Module  module" + module.getModule());
								System.out.println("Field HistoryTracking Module  module name" + module.getModuleName());
							}
							MinifiedModule durationConfigured = historytracking.getDurationConfiguredField();
							if (durationConfigured != null)
							{
								System.out.println("Field HistoryTracking DurationConfiguredField" + durationConfigured.getId());
							}
						}

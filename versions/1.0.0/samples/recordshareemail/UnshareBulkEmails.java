...
{
	public static void unshareBulkEmails(String moduleAPIName) throws Exception
	{
		RecordShareEmailOperations recordShareEmailOperations = new RecordShareEmailOperations(moduleAPIName);
		BodyWrapper request = new BodyWrapper();
		request.setIds(new ArrayList<>(Arrays.asList(34771023l, 347720l)));
	...
	public static void main(String[] args)
	{
		try
		{
			...
			unshareBulkEmails(moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();

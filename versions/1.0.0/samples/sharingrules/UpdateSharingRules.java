...
public class UpdateSharingRules
{
	...
	public static void updateSharingRules(String moduleAPIName) throws Exception
	{
...
//		sharingRule.setCriteria(criteria);
	...
	public static void main(String[] args)
	{
		try
		{
			...
			updateSharingRules(moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();

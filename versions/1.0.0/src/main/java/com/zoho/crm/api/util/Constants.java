...
public class Constants
{
	...
	public static final ArrayList<String> SET_CONTENT_TYPE_HEADER = new ArrayList<String>(Arrays.asList("/crm/bulk/v8/read", "/crm/bulk/v8/write", "/crm/v8/__zia_org_enrichment", "crm/v8/__zia_people_enrichment"));
	...
	public static final String API_VERSION = "v8";
	...
	public static final ArrayList<String> SA_DATACENTER = new ArrayList<String>(Arrays.asList("https://www.zohoapis.sa", "https://sandbox.zohoapis.sa", "https://developer.zohoapis.sa", "https://accounts.zoho.sa/oauth/v2/token", "sa"));
	...
	public static final String FUNCTIONS = "v8/functions";
	public static final String FUNCTIONS_PATH = "/actions/execute";
}

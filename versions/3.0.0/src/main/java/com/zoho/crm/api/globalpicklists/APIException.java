...
public class APIException implements ActionResponse, Model, ResponseHandler, ActionHandler, ReplaceActionHandler, ReplaceActionResponse, ReplacedResponseHandler, AssociationsResponseHandler, PickListValuesAssociationsResponseHandler
{

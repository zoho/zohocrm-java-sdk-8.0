...
import com.zoho.crm.api.webforms.VisitorTracking;
...
import com.zoho.crm.api.webforms.AcknowledgeVisitor;

public class UpdateWebForm
{
	public static void updateWebForm(String moduleAPIName, String formId) throws Exception
	{
		...
		notifyOwner.setId("347706124");
		webform.setNotifyOwner(notifyOwner);
		AcknowledgeVisitor  acknowledgeVisitors = new AcknowledgeVisitor();
		webform.setAcknowledgeVisitor(acknowledgeVisitors);
		VisitorTracking visitorTracking = new VisitorTracking();
		webform.setVisitorTracking(visitorTracking);

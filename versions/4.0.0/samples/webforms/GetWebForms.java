...
public class GetWebForms
{
	public static void getWebForms(String moduleAPIName) throws Exception
	{
		WebformsOperations webformsOperations = new WebformsOperations(moduleAPIName);
		APIResponse<ResponseHandler> response = webformsOperations.getWebForms();
		if (response != null)
		{

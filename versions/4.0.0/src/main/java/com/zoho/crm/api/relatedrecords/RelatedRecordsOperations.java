...
public class RelatedRecordsOperations
{
	...
	public static class GetRelatedRecordsParam
	{
		...
		public static final Param<String> IDS = new Param<String>("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsParam");
	...
	public static class GetRelatedRecordsUsingExternalIDParam
	{
		...
		public static final Param<String> IDS = new Param<String>("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsUsingExternalIDParam");

...
{
	public static void getWebForm(String moduleAPIName, String formId) throws Exception
	{
		WebformsOperations webformsOperations = new WebformsOperations(moduleAPIName);
		APIResponse<ResponseHandler> response = webformsOperations.getWebForm(formId);
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (WebForm webform : webforms)
					{
						...
						AcknowledgeVisitor acknowledgeVisitors = webform.getAcknowledgeVisitor();
						...
						List<Fields> formFields = webform.getFields();
						if (formFields != null)
						{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String formId = "347708001";
			getWebForm(moduleAPIName, formId);
		}
		catch (Exception e)
		{
			e.printStackTrace();

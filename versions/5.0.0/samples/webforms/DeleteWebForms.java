...
public class DeleteWebForms
{
	public static void deleteWebForms(String moduleAPIName, String formId) throws Exception
	{
		WebformsOperations webformsOperations = new WebformsOperations(moduleAPIName);
		APIResponse<ActionHandler> response = webformsOperations.deleteWebForms(formId);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String formId = "34778001";
			deleteWebForms(moduleAPIName, formId);
		}
		catch (Exception e)
		{
			e.printStackTrace();

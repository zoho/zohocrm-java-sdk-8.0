...
public class ExecuteFunctionUsingRequestBody
{
	public static void executeFunctionUsingRequestBody() throws Exception
	{
        ...
        requestBody.put("name", "JavaScript");
        requestBody.put("version", "4.0.0");

        HashMap<String, String> sample = new HashMap<>();
        sample.put("name", "JAVASCRIPT-2.1");
        ...
        paramInstance.add(new Param<>("Java", Object.class.getCanonicalName()), param);

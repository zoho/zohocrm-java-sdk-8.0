...
{
	public static void disableNotifications(List<String> channelIds) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			ArrayList<String> channelIds = new ArrayList<String>(Arrays.asList("34770615208001"));

...
public class SectionField extends Fields implements Model
{
	...
	private Picklist globalPicklist;
	...
	/**
	 * The method to get the value of fileUploadOptionlist
	 * @return An instance of List<FileUploadOption>
	 */
	public List<FileUploadOption> getFileUploadOptionlist()
	{
	...
	/**
	 * The method to set the value to fileUploadOptionlist
	 * @param fileUploadOptionlist An instance of List<FileUploadOption>
	 */
	public void setFileUploadOptionlist(List<FileUploadOption> fileUploadOptionlist)
	{
		 this.fileUploadOptionlist = fileUploadOptionlist;

		 this.keyModified.put("file_upload_optionlist", 1);
	...
	/**
	 * The method to get the value of historyTrackingEnabled
	 * @return A Boolean representing the historyTrackingEnabled
	 */
	public Boolean getHistoryTrackingEnabled()
	{
	 ...
	 */
	public void setHistoryTrackingEnabled(Boolean historyTrackingEnabled)
	{
		 this.historyTrackingEnabled = historyTrackingEnabled;

		 this.keyModified.put("history_tracking_enabled", 1);
	 ...
	 */
	public Picklist getGlobalPicklist()
	{
	 ...
	 */
	public void setGlobalPicklist(Picklist globalPicklist)
	{

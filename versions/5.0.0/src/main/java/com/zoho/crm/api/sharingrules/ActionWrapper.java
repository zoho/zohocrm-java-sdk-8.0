...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getSharingRules()
	{
	 ...
	 * @param sharingRules An instance of List<ActionResponse>
	 */
	public void setSharingRules(List<ActionResponse> sharingRules)
	{
